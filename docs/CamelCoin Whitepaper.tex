...
In this example, we can see that \ac{RASTiC} is actually slower when verifying messages with fewer than 10 tokens. This is due to the need to tokenize and reload the message into VRAM multiple times.
This can be eliminated with custom code, but there aren't libraries with enough flexibility to support this at the moment.
